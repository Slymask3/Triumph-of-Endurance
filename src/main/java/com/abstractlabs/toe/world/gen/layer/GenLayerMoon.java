package com.abstractlabs.toe.world.gen.layer;
...
public class GenLayerMoon extends GenLayer {
	 ...
	 public GenLayerMoon(long seed, GenLayer genlayer, WorldType worldtype) {
		 super(seed);
	     ...
	     if (worldtype == WorldType.DEFAULT_1_1) {
	         ...
	         desertBiomes.add(new BiomeEntry(ToeBiomes.biomeMoon, 10));
	     } else {
