...
public class ChunkProviderNeptune implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderNeptune(World world, long par2, boolean mapFeatures)
    {
        this.worldObj = world;
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    p_147424_3_[j3 += short1] = Blocks.packed_ice;
                                }
                                else if (k2 * 8 + l2 < b0)
                                {
