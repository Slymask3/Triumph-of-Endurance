...
public class TeleporterHollows extends Teleporter {
    ...
    public TeleporterHollows(WorldServer p_i1963_1_)
    {
    	super(p_i1963_1_);
	...
	public boolean placeInExistingPortal(Entity p_77184_1_, double p_77184_2_, double p_77184_4_, double p_77184_6_, float p_77184_8_)
    {
        ...
        {
            TeleporterHollows.PortalPosition portalposition = (TeleporterHollows.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
        ...
        else
        {
            for (l3 = l - short1; l3 <= l + short1; ++l3)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(l3, i2, l1) == ToeBlocks.hollowPortal)
                        {
                            while (this.worldServerInstance.getBlock(l3, i2 - 1, l1) == ToeBlocks.hollowPortal)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.destinationCoordinateCache.add(j1, new TeleporterHollows.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
            ...
            if (this.worldServerInstance.getBlock(i - 1, j, k) == ToeBlocks.hollowPortal)
            {
                i4 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(i, j, k - 1) == ToeBlocks.hollowPortal)
            {
                i4 = 3;
            }
