...
public class TileEntityFurnaceDiamond extends TileEntity implements ISidedInventory {
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.name : "Diamond Furnace";
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (flag != this.furnaceBurnTime > 0) {
                flag1 = true;
                BlockFurnaceDiamond.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
