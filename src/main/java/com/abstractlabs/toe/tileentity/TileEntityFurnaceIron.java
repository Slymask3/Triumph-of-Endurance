...
public class TileEntityFurnaceIron extends TileEntity implements ISidedInventory {
    ...
    private static double speedModifier = Smelting.furnaceSpeedModifier_Iron;
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.name : "Iron Furnace";
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (flag != this.furnaceBurnTime > 0) {
                flag1 = true;
                BlockFurnaceIron.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
