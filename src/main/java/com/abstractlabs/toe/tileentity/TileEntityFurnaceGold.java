...
public class TileEntityFurnaceGold extends TileEntity implements ISidedInventory {
    ...
    private static double speedModifier = Smelting.furnaceSpeedModifier_Gold;
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.name : "Gold Furnace";
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (flag != this.furnaceBurnTime > 0) {
                flag1 = true;
                BlockFurnaceGold.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
