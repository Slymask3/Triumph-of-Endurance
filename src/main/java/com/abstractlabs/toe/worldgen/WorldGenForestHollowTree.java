...
public class WorldGenForestHollowTree extends WorldGenForestAbstractTree
{
	...
	public WorldGenForestHollowTree(boolean par1)
	{
		this(par1, 8, 0, 0, false);
	}
	public WorldGenForestHollowTree(boolean par1, int par2, int par3, int par4, boolean par5)
	{
		super(par1);
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
	{
		...
		if (p_76484_4_ >= 1 && p_76484_4_ + l + 1 <= 256)
		{
			...
			else
			{
				...
				boolean isSoil = block2.canSustainPlant(p_76484_1_, p_76484_3_, p_76484_4_ - 1, p_76484_5_, ForgeDirection.UP, (BlockHollowSapling)ToeBlocks.hollowSapling);
				if (isSoil && p_76484_4_ < 256 - l - 1)
				{
						...
						for (i2 = p_76484_3_ - l1; i2 <= p_76484_3_ + l1; ++i2)
						{
							...
							for (int k2 = p_76484_5_ - l1; k2 <= p_76484_5_ + l1; ++k2)
							{
								...
								if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || p_76484_2_.nextInt(2) != 0 && i3 != 0)
								{
									...
									{
										this.setBlockAndNotifyAdequately(p_76484_1_, i2, k1, k2, ToeBlocks.hollowLeaf, 0);
									}
								}
							}
						}
					...
					for (k1 = 0; k1 < l; ++k1)
					{
						...
						{
							this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + k1, p_76484_5_, ToeBlocks.hollowLog, 0);
