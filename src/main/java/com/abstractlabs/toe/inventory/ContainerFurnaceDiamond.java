...
public class ContainerFurnaceDiamond extends Container {
    private TileEntityFurnaceDiamond tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerFurnaceDiamond(InventoryPlayer inventory, TileEntityFurnaceDiamond te) {
        this.tileFurnace = te;
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int slotPos) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotPos == 2) {
                ...
                } else if (TileEntityFurnaceDiamond.isItemFuel(itemstack1)) {
