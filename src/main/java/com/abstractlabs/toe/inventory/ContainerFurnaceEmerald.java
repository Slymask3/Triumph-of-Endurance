...
public class ContainerFurnaceEmerald extends Container {
    private TileEntityFurnaceEmerald tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerFurnaceEmerald(InventoryPlayer inventory, TileEntityFurnaceEmerald te) {
        this.tileFurnace = te;
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int slotPos) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotPos == 2) {
                ...
                } else if (TileEntityFurnaceEmerald.isItemFuel(itemstack1)) {
