...
public class ContainerFurnaceGold extends Container {
    private TileEntityFurnaceGold tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerFurnaceGold(InventoryPlayer inventory, TileEntityFurnaceGold te) {
        this.tileFurnace = te;
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int slotPos) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotPos == 2) {
                ...
                } else if (TileEntityFurnaceGold.isItemFuel(itemstack1)) {
