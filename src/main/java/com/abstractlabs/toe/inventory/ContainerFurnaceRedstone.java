...
public class ContainerFurnaceRedstone extends Container {
    private TileEntityFurnaceRedstone tileFurnace;
    ...
    public ContainerFurnaceRedstone(InventoryPlayer inventory, TileEntityFurnaceRedstone te) {
        this.tileFurnace = te;
        this.addSlotToContainer(new Slot(te, INPUT, 56, 17));
        this.addSlotToContainer(new Slot(te, FUEL, 56, 53));
        this.addSlotToContainer(new SlotFurnace(inventory.player, te, OUTPUT, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int slotPos) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotPos == OUTPUT) {
                ...
                } else if (TileEntityFurnaceRedstone.isItemFuel(itemstack1)) {
