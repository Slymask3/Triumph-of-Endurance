...
public class BlockArmoury extends BlockContainer implements ITileEntityProvider
{
	private IIcon top;
	private IIcon side;
    ...
    {
    	player.openGui(Toe.instance, GuiID.ARMOURY.ordinal(), world, x, y, z);
    ...
    {
		top = ir.registerIcon(Reference.MOD_ID + ":armoury_top");
		side = ir.registerIcon(Reference.MOD_ID + ":armoury_side");
	}
