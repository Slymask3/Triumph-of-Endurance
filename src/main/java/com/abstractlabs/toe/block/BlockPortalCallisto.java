...
public class BlockPortalCallisto extends BlockPortal {
	...
	public void onNeighborBlockChange(World world, int x, int y, int z, Block block){
		...
		if(world.getBlock(x - 1, y, z) == ToeBlocks.moonBrick || world.getBlock(x + 1, y, z) == ToeBlocks.moonBrick){
			b0 = 1;
			b1 = 0;
		}
		...
		if(world.getBlock(x, i1 - 1, z) != ToeBlocks.moonBrick){
			...
			if(j1 == 3 && world.getBlock(x, i1 + j1, z) == ToeBlocks.moonBrick){
				...
				if(flag && flag1){
					...
					if((world.getBlock(x+b0, y, z+b1) != ToeBlocks.moonBrick || world.getBlock(x-b0, y, z-b1) != this) && (world.getBlock(x-b0, y, z-b1) !=ToeBlocks.moonBrick || world.getBlock(x+b0, y, z+b1) != this)){
						world.setBlockToAir(x, y, z);
					}
				}
			}else{
	...
	public boolean tryTroCreatePortal(World world, int x, int y, int z){
		...
		if (world.getBlock(x, y, z - 1) == ToeBlocks.moonBrick || world.getBlock(x, y, z + 1) == ToeBlocks.moonBrick){
			b1 = 1;
		}
	...
	public boolean getPortalSize(World world, int x, int y, int z) {
		BlockPortalCallisto.Size size = new BlockPortalCallisto.Size(world, x, y, z, 1);
		BlockPortalCallisto.Size size1 = new BlockPortalCallisto.Size(world, x, y, z, 2);
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_) {
        ...
        for (int l = 0; l < 4; ++l) {
            ...
            ParticleEffects.spawnParticle("portalCallisto", d0, d1, d2, d3, d4, d5);
        }
    }
	...
	public static class Size {
		...
		protected int func_150853_a(int x, int y, int z, int p_150853_4_) {
			...
			for (i1 = 0; i1 < 22; ++i1) {
				...
				if (block1 != ToeBlocks.moonBrick) {
					break;
				}
			}

			block = this.worldObj.getBlock(x + j1 * i1, y, z + k1 * i1);
			return block == ToeBlocks.moonBrick ? i1 : 0;
		}
		...
		protected int func_150858_a() {
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g) {
					...
					for (j = 0; j < this.field_150868_h; ++j) {
						...
						if (block == ToeBlocks.portalCallisto) {
							++this.field_150864_e;
						}
			...
			for (i = 0; i < this.field_150868_h; ++i) {
				...
				if (this.worldObj.getBlock(j, k, l) != ToeBlocks.moonBrick) {
		...
		protected boolean getBlockMaterial(Block block) {
			return block.getMaterial() == Material.air || block == ToeBlocks.hollowFire || block == Blocks.fire || block == ToeBlocks.portalCallisto;
		}
		...
		public void func_150859_c() {
			for (int i = 0; i < this.field_150868_h; ++i) {
				...
				for (int l = 0; l < this.field_150862_g; ++l) {
					...
					this.worldObj.setBlock(j, i1, k, ToeBlocks.portalCallisto, this.field_150865_b, 2);
				}
			}
		}
	}
