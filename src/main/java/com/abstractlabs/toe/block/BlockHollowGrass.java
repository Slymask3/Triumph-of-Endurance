...
public class BlockHollowGrass extends BlockBasic implements IGrowable
{
	...
	public BlockHollowGrass(Material material, String blockName, SoundType stepSound)
	{
		super(material);
	...
	{
		return p_149691_1_ == 1 ? this.field_149991_b : (p_149691_1_ == 0 ? ToeBlocks.hollowDirt.getBlockTextureFromSide(p_149691_1_) : this.blockIcon);
	}
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
	{
		if (!p_149674_1_.isRemote)
		{
			...
			{
				p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, ToeBlocks.hollowDirt);
			}
			else if (p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1, p_149674_4_) >= 9)
			{
				for (int l = 0; l < 4; ++l)
				{
					...
					if (p_149674_1_.getBlock(i1, j1, k1) == ToeBlocks.hollowDirt && p_149674_1_.getBlockMetadata(i1, j1, k1) == 0 && p_149674_1_.getBlockLightValue(i1, j1 + 1, k1) >= 4 && p_149674_1_.getBlockLightOpacity(i1, j1 + 1, k1) <= 2)
					{
						p_149674_1_.setBlock(i1, j1, k1, ToeBlocks.hollowDirt);
					}
				}
			}
		}
	...
	{
		return ToeBlocks.hollowDirt.getItemDropped(0, p_149650_2_, p_149650_3_);
	}
	...
	public IIcon getIcon(IBlockAccess p_149673_1_, int p_149673_2_, int p_149673_3_, int p_149673_4_, int p_149673_5_)
	{
		...
		{
			return ToeBlocks.hollowDirt.getBlockTextureFromSide(p_149673_5_);
		}
		else
		{
	...
	{
		this.blockIcon = p_149651_1_.registerIcon(Reference.MOD_ID + ":hollowGrass_side");
		this.field_149991_b = p_149651_1_.registerIcon(Reference.MOD_ID + ":hollowGrass_top");
	}
		...
		while (l < 128)
		{
			...
			while (true)
			{
				if (l1 < l / 16)
				{
					...
					if (p_149853_1_.getBlock(i1, j1 - 1, k1) == ToeBlocks.hollowDirt && !p_149853_1_.getBlock(i1, j1, k1).isNormalCube())
					{
						++l1;
						continue;
					}
