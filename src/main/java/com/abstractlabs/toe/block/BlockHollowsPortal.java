...
public class BlockHollowsPortal extends BlockBreakable
{
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) 
	{
		if ((entity.ridingEntity == null) && (entity.riddenByEntity == null) && ((entity instanceof EntityPlayerMP))) 
		{
			...
			else if (thePlayer.dimension != ToeDimensions.hollowsID) 
			{
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, ToeDimensions.hollowsID, new TeleporterHollows(thePlayer.mcServer.worldServerForDimension(ToeDimensions.hollowsID)));
			} 
			else if (thePlayer.dimension == ToeDimensions.hollowsID)
			{
				thePlayer.timeUntilPortal = 10;
