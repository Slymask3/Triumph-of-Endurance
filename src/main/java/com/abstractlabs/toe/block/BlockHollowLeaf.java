...
public class BlockHollowLeaf extends BlockLeaf
{
	public static final String[][] field_150130_N = new String[][] {{":leaves_hollow"}, {":leaves_hollow_opaque"}};
	public static final String[] field_150131_O = new String[] {"hollows"};


	@SuppressWarnings("unused")
	private static final String __OBFID = "CL_00000280";

	public BlockHollowLeaf(String blockName, String textureName){
	 ...
	 */
	 ...
	 public void registerBlockIcons(IIconRegister p_149651_1_)
	 {
		 for (int i = 0; i < field_150130_N.length; ++i)
		 {
			 ...
			 {
				 this.field_150129_M[i][j] = p_149651_1_.registerIcon(Reference.MOD_ID + field_150130_N[i][j]);
			 }
		 }
	 }
