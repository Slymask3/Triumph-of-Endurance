...
public class RangedGUI extends Gui {
	Minecraft mc = Minecraft.getMinecraft();
	
	public static int lvl;
	public static int percent;

	private String texture = Skill.texture_ranged;
	private String texture_gold = Skill.texture_ranged_gold;
	private int xPos = Skill.guiX_2;
	private int yPos = Skill.guiY_2;
