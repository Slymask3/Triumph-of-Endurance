...
public class RangedHelper implements IExtendedEntityProperties {
	private final EntityPlayer player;
	private static final String NBT = "ToeSkills";
	private static final String SKILL = "RangedSkill";
	...
	public static void addProperties(EntityPlayer player) {
		player.registerExtendedProperties(SKILL, new RangedHelper(player));
	}
	
	public static RangedHelper getProperties(EntityPlayer player) {
		return (RangedHelper)player.getExtendedProperties(SKILL);
	}
	...
	public void setExperience(float i) {
		...
		if ((this.player instanceof EntityPlayerMP))
			ToePackets.network.sendTo(new RangedPacket(this.level, progressPercentage()), (EntityPlayerMP)this.player);
	}
