...
public class MiningGUI extends Gui {
	...
	private String texture = Skill.texture_mining;
	private String texture_gold = Skill.texture_mining_gold;
	private int xPos = Skill.guiX_4;
	private int yPos = Skill.guiY_4;
