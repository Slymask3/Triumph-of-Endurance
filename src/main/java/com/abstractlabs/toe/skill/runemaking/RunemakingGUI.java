...
public class RunemakingGUI extends Gui {
	Minecraft mc = Minecraft.getMinecraft();
	
	public static int lvl;
	public static int percent;

	private String texture = Skill.texture_runemaking;
	private String texture_gold = Skill.texture_runemaking_gold;
	private int xPos = Skill.guiX_11;
	private int yPos = Skill.guiY_11;
