...
public class BrewingGUI extends Gui {
	...
	private String texture = Skill.texture_brewing;
	private String texture_gold = Skill.texture_brewing_gold;
	private int xPos = Skill.guiX_10;
	private int yPos = Skill.guiY_10;
