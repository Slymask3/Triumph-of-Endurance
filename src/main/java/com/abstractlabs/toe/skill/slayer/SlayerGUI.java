...
public class SlayerGUI extends Gui {
	...
	private String texture = Skill.texture_slayer;
	private String texture_gold = Skill.texture_slayer_gold;
	private int xPos = Skill.guiX_13;
	private int yPos = Skill.guiY_13;
