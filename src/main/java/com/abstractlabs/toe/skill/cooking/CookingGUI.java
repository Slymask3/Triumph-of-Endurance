...
public class CookingGUI extends Gui {
	...
	private String texture = Skill.texture_cooking;
	private String texture_gold = Skill.texture_cooking_gold;
	private int xPos = Skill.guiX_8;
	private int yPos = Skill.guiY_8;
