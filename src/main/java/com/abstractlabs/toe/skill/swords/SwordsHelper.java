package com.abstractlabs.toe.skill.swords;
...
public class SwordsHelper implements IExtendedEntityProperties {
	private final EntityPlayer player;
	private static final String NBT = "ToeSkills";
	private static final String SKILL = "SwordsSkill";
	private static final String LEVEL = "SwordsLevel";
	private static final String EXP = "SwordsExp";
	private float exp;
	private int level;
	
	public SwordsHelper(EntityPlayer player) {
		this.player = player;
		this.level = 1;
		this.exp = 0.0F;
	}
	...
	public static void addProperties(EntityPlayer player) {
		player.registerExtendedProperties(SKILL, new SwordsHelper(player));
	}
	
	public static SwordsHelper getProperties(EntityPlayer player) {
		return (SwordsHelper)player.getExtendedProperties(SKILL);
	}
