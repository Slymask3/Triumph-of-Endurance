...
public class SmeltingGUI extends Gui {
	Minecraft mc = Minecraft.getMinecraft();
	
	public static int lvl;
	public static int percent;

	private String texture = Skill.texture_smelting;
	private String texture_gold = Skill.texture_smelting_gold;
	private int xPos = Skill.guiX_9;
	private int yPos = Skill.guiY_9;
