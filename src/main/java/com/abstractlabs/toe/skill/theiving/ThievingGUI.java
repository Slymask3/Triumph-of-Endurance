...
public class ThievingGUI extends Gui {
	...
	private String texture = Skill.texture_thieving;
	private String texture_gold = Skill.texture_thieving_gold;
	private int xPos = Skill.guiX_15;
	private int yPos = Skill.guiY_15;
