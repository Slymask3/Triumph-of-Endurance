...
public class FarmingGUI extends Gui {
	Minecraft mc = Minecraft.getMinecraft();
	
	public static int lvl;
	public static int percent;

	private String texture = Skill.texture_farming;
	private String texture_gold = Skill.texture_farming_gold;
	private int xPos = Skill.guiX_7;
	private int yPos = Skill.guiY_7;
