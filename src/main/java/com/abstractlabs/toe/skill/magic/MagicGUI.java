...
public class MagicGUI extends Gui {
	...
	private String texture = Skill.texture_magic;
	private String texture_gold = Skill.texture_magic_gold;
	private int xPos = Skill.guiX_3;
	private int yPos = Skill.guiY_3;
