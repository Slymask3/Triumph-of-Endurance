...
public class FishingGUI extends Gui {
	...
	private String texture = Skill.texture_fishing;
	private String texture_gold = Skill.texture_fishing_gold;
	private int xPos = Skill.guiX_6;
	private int yPos = Skill.guiY_6;
