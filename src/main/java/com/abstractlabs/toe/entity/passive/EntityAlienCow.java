...
public class EntityAlienCow extends EntityAnimal {
    public EntityAlienCow(World world) {
        super(world);
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        for (k = 0; k < j; ++k)
        {
            this.dropItem(ToeItems.greenLeather, 1);
        }
        ...
        for (k = 0; k < j; ++k)
        {
            if (this.isBurning())
            {
                this.dropItem(ToeItems.alienSteak, 1);
            }
            else
            {
                this.dropItem(ToeItems.alienBeef, 1);
            }
        }
    }
    ...
    public EntityAlienCow createChild(EntityAgeable p_90011_1_)
    {
        return new EntityAlienCow(this.worldObj);
    }
