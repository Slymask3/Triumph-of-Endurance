...
public class BiomeHandler 
{
	...
	{
		e.newBiomeGens = initializeAllBiomeGenerators_Toe(e.seed, e.worldType);
	}

	// copied from GenLayer.class initializeAllBiomeGenerators()
	// with only one changed input
	public static GenLayer[] initializeAllBiomeGenerators_Toe(long par0, WorldType par2WorldType)
	{
		boolean flag = false;
		...
		GenLayer ret = new HollowsGenLayerBiome(200L, genlayer3, par2WorldType);
