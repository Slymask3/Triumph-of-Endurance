...
public class ItemToeBow extends ItemToe
{
	...
	public void onPlayerStoppedUsing(ItemStack stack, World world, EntityPlayer player, int time)
	{
		...
		if (infiniteAmmo || player.inventory.hasItem(ammo)) 
		{
			...
			EntityToeArrow entityarrow = new EntityToeArrow(world, player, scaledItemUse*2, damage, ammo.getUnlocalizedName().replace("item.arrow", ""));
