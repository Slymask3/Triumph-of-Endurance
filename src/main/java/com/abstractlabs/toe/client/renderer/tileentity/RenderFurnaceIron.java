...
public class RenderFurnaceIron implements ISimpleBlockRenderingHandler {
	public static final RenderFurnaceIron INSTANCE = new RenderFurnaceIron();
	
	@Override
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
		int meta=3;
		if(block == ToeBlocks.furnaceIronLit)meta=1;
