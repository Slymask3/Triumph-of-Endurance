...
public class EntityCallistoPortalFX extends EntityFX {
    private float portalParticleScale;
    private double portalPosX;
    private double portalPosY;
    private double portalPosZ;

    public EntityCallistoPortalFX(World world, double x, double y, double z, double vx, double vy, double vz) {
